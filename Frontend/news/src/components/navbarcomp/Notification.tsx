...
const Notification: React.FC<NotificationProps> = ({ unreadCount, setUnreadNotificationCount }) => {
  ...
  return (
    <div className="relative" ref = {notificationRef}>
      ...
      {isOpen && (
        <div className="fixed inset-x-0 rounded-md top-16 sm:right-0 sm:left-auto sm:absolute sm:top-full text-black bg-white shadow-lg p-4 mt-2 w-full sm:w-80 md:w-96 max-h-[80vh] overflow-y-auto flex-grow z-50 scrollbar-hide">
