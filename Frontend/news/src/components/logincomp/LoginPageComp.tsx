...
const Fnt = Poppins({ subsets: ["latin"], weight: ["600"] });
    ...
    <main className="bg-gray-100 min-h-screen flex items-center justify-center p-4">
      <div className="sm:w-full md:w-4/5 max-w-6xl bg-white rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
          <h1
            className={`${Dmse.className} text-4xl text-black text-center mb-4 md:mb-8`}
          >
            The Global Buzz
          </h1>
          <p className="text-gray-600 text-center text-sm mb-8">
            &quot;Delivering the World&apos;s Hottest Buzz, Packed with Global
            Insight&quot;
          </p>

          <p className="text-xs text-gray-500 mb-4">
            By continuing you indicate that you agree to The Global Buzz&apos;s
            Terms of Service and Privacy Policy.
          </p>

          <button
            onClick={() => signIn("google", { callbackUrl: "/main" })}
            className="w-full flex items-center justify-center gap-2 bg-white border border-gray-300 text-gray-700 rounded-md py-2 px-4 hover:bg-gray-50 mb-4"
          >
          ...
          <button
            onClick={() => signIn("facebook", { callbackUrl: "/main" })}
            className="w-full flex items-center justify-center gap-2 bg-blue-600 text-white rounded-md py-2 px-4 hover:bg-blue-700 mb-4"
          >
        ...
        <div className="w-full md:w-1/2 bg-gray-50 flex flex-col justify-center">
          <div
            className={`${Fnt.className} text-black text-3xl font-semibold text-center p-2 md:mb-0 mt-8 py-9`}
          >
            Login
          </div>
          <form onSubmit={onSubmit} className="space-y-4 p-8 -mt-6">
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                type="submit"
                className="bg-black text-white rounded-md py-1 px-4 hover:bg-slate-800"
              >
                Login
              </button>
            </div>
